          ...
          <div class="row">
            <div class="col-6">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="live-preview">
                    <form class="row g-3 needs-validation" action="?act=addUser" method="POST">
                      <div class="col-md-12">
                  ...
                  <div class="row live-preview">
                    <form class="row g-3 needs-validation" action="?act=addUser" method="POST" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="col-md-4 mt-3">
                        ...
                        <input type="text" class="form-control" id="price" name="price" value="<?= $resultTotalPrice['tong_tien'] ?>" required>
                      </div>
