      ...
      <div class="page-content">
        <div class="container-fluid">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0">Thêm mã khuyến mãi</h4>
          ...
          <div class="card">
            <div class="card-body">
              <div class="live-preview">
                <form class="row g-3 needs-validation" action="?act=addDiscount" method="POST" novalidate>
                  <div class="col-md-12">
                    <label for="ma-km" class="form-label">Mã khuyến mãi</label>
                    <input type="text" class="form-control" id="ma-km" name="code" placeholder="Nhập mã khuyến mãi" required>
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="date" name="startDate" class="form-control" id="ngay-bat-dau">
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="date" name="endDate" class="form-control" id="ngay-ket-thuc">
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" name="percent" class="form-control" id="phan-tram" placeholder="Nhập phần trăm khuyến mãi" required>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-12">
                    ...
                    <a class="btn" href="?act=listDiscount" type="reset">Hủy</a>
                  </div>
                </form>
              </div>
            </div>
