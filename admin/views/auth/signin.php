                ...
                <div class="col-lg-6">
                  <div class="p-lg-5 p-4">
                    <div>
                      ...
                      <p class="text-muted">Đăng nhập để mua sắm tại Seven store.</p>
                    </div>
                    ...
                    <?php } ?>
                      <form action="?act=handleSignin" method="post">
                        ...
                        <div class="mb-3">
                          <div class="float-end">
                            <a href="?act=fogotPassword" class="text-muted">Quên mật khẩu?</a>
                          </div>
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="auth-remember-check">Ghi nhớ cho lần sau</label>
                        </div>

                        <div class="mt-4">
                          <button class="btn btn-success w-100" type="submit" name="login">Đăng nhập</button>
                        </div>
                    ...
                    <!-- <div class="mt-5 text-center">
                      <p class="mb-0">Bạn chưa có tài khoản ? <a href="?act=signup" class="fw-semibold text-primary text-decoration-underline"> Đăng ký</a> </p>
                    </div> -->
                  </div>
                </div>
                <!-- end col -->
