...
class DashboardController
{
  ...
  public function index()
  {
    ...
    $resultEarning = ((($getTotalEarningWithCurrentMonth['tong_thanh_toan'] - $getTotalEarningWithOldMonth['tong_thanh_toan']) * 100 ) / $getTotalEarningWithOldMonth['tong_thanh_toan']);
    ...
    $resultOrders = ((($getTotalOrdersWithCurrentMonth['tong_don_hang'] - $getTotalOrdersWithOldMonth['tong_don_hang']) * 100 ) / $getTotalOrdersWithOldMonth['tong_don_hang']);
    ...
    $resultProfit = ((($getTotalProfitWithCurrentMonth['loi_nhuan'] - $getTotalProfitWithOldMonth['loi_nhuan']) * 100 ) / $getTotalProfitWithOldMonth['loi_nhuan']);
