            ...
            <div class="container container-fluid-custom-mobile-padding">
                ...
                <div class="row">
                    <div class="col-12">
                           ...
                           <?php  foreach ($viewBlog as $blog) : if($blog['trang_thai'] == 1){ ?>
                            <div class="tt-post">
                                <div class="tt-post-img">
                                    <a href="?act=blog-post&id=<?= $blog['id'] ?>"><img src="<?= BASE_URL_ADMIN.'/'. $blog['anh_avt']?>" alt="anh 1"></a>
                                </div>
                                <div class="tt-post-content">
                                    <h2 class="tt-title"><a href="?act=blog-post&id=<?= $blog['id'] ?>"> <?=  $blog['tieu_de'] ?> </a></h2>
                        ...
                        <div class="tt-pagination-wrapper">
